...
def plot_runs(k3_infile, k2_infile, dataset_tame, outfile_prefix):
...
def plot_runs_allk(k1_infile, k2_infile, k3_infile, k4_infile, dataset_tame, outfile_prefix): 
    ...
    do_scatter_plot2(k1_t, k1_counts, k2_t, k2_counts,k3_t, k3_counts, k4_t, k4_counts,
                    ...
                    "Flipped Unitigs {}".format(dataset_tame),
                    "{}_fmin_by_t.pdf".format(outfile_prefix))
...
#plot_runs_allk("data_for_plots/f_ERR5035349-unitigs-k21.sbwttest.txt", "data_for_plots/f_ERR5035349-unitigs-k31.sbwttest.txt","data_for_plots/f_ERR5035349-unitigs-k63.sbwttest.txt", "data_for_plots/f_ERR5035349-unitigs-k127.sbwttest.sbwttest.txt", "Metagenome", "test_plots/metagenome_funitigs")
